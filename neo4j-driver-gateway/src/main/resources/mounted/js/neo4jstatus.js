...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Neo4JStatus = __webpack_require__(44);
	
	var _Neo4JStatus2 = _interopRequireDefault(_Neo4JStatus);
	...
	var MountableApp = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            { store: store },
	            _react2.default.createElement(_Neo4JStatus2.default, { dispatch: store.dispatch })
	        );
	    }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ignitionLib = __webpack_require__(43);
	
	var CONNECTIONS_LOAD = 'neo/CONNECTIONS_LOAD';
	var CONNECTIONS_ERR = 'neo/CONNECTIONS_ERR';
	var CONNECTIONS_DETAIL_LOAD = 'neo/CONNECTIONS_DETAIL_LOAD';
	var CONNECTIONS_DETAIL_ERR = 'neo/CONNECTIONS_DETAIL_ERR';
	
	var VIEW_ALL = "neo/VIEW_ALL";
	var VIEW_CONNECTION = "neo/VIEW_CONNECTION";
	var FETCH_PERMISSIONS = "neo/FETCH_PERMISSIONS";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ignitionReact = __webpack_require__(45);
	...
	var ConnectOverview = function (_Component) {
	    ...
	    _createClass(ConnectOverview, [{
	        ...
	        value: function render() {
	            ...
	            if (connections != null) {
	                var HEADERS = [{ header: 'Connection Name', weight: 2 }, { header: 'Connection Type', weight: 1 }];
	                ...
	                if (connectionCount > 0) {
	                    ...
	                    if (connectionList != null) {
	                        items = connectionList.map(function (connection) {
	                            return [connection.ConnectionName, connection.ConnectionType];
	                        });
	                    }
